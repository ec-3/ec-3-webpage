...
const allLinks = [
    {
        title: 'Explore',
        links: [
            {name: 'Download Ec³ App', href: 'https://www.baidu.com/'},
            {name: 'Shopping Car', href: 'https://www.baidu.com/'},
        ]
    },
    {
        title: 'Documents',
        links: [
            {name: 'Developers', href: 'https://www.baidu.com/'},
            {name: 'Mine', href: 'https://www.baidu.com/'},
            {name: 'Tokenomic', href: 'https://www.baidu.com/'}
        ]
    },
    {
        title: 'Useful links',
        links: [
            {name: 'FAQs', href: 'https://www.baidu.com/'},
            {name: 'Product User Guide', href: 'https://www.baidu.com/'},
        ]
    },
    {
